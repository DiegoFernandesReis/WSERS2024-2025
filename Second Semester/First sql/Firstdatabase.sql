...
Insert into Users(Name,Email,CountryId) Values("Dan","dude@lpem", 5)
Insert into Users(Name,Email,CountryId) Values("Ayman","ayman@lpem", 4)
Insert into Users(Name,Email,CountryId) Values("Diego","diego@lpem", 1)
